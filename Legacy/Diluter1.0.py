...
def dilute(count_per_square: float, final_plate: float) -> None:
    init_cells_ml = (count_per_square/4.0)*(10**6)
    print(f"\nInitial cells per mL: {init_cells_ml:.4e}")
...
def initiate() -> None:
    ...
    print("Initial number of cells refers to the average number of cells on the 1/25th of hematocrit slide.\nFor best results take the average of at least three of these squares.")
    ...
    while looping:
        ...
        dilute(initial_cells,final_cells)
